...
- **Single Card Reading** — Quick snapshot for daily guidance  
...
Clone this repo and run your preferred static site workflow:

```bash
git clone https://github.com/slimsheazy/sibsite.git
cd sibsite
# Start your dev server or deploy directly via GitHub Pages
```

Structure your content in Markdown/HTML and customize as needed. Deploy via GitHub Pages, Netlify, Vercel, or any static hosting platform.

---

## Roadmap

- [ ] Add structured landing pages for each reading type with story-focused descriptions  
- [ ] Integrate booking and payment flows directly into the site (Etsy embed, Gumroad, or custom checkout)  
- [ ] Launch a content hub for tarot essays, spread tutorials, and behind-the-scenes Sibylhaus updates  
- [ ] Build out couples-focused features and tools (interactive spreads, shared journaling)  
- [ ] Expand audio/visual reading catalog with sample clips and preview content  
- [ ] SEO optimization for Etsy listings and organic traffic growth
...
- **FitFinder** — Fitness discovery app  
- **ScopesSizer** — Astrology tool for zodiacal systems  
- **PolicyPlain** — Policy simplification tool  
- **SLOTTER, Protocol, Glyphic** — Additional app experiments

All projects share a focus on intuitive UI, accessible design, and human-centered experiences.

---

## Contributing

This is a personal project and portfolio site. If you have feedback, suggestions, or want to collaborate, feel free to open an issue or reach out via Instagram.

---

## License

This project's code and content are proprietary to Sibylhaus. All rights reserved unless otherwise noted.

---

**Built with intention. Read with curiosity. Navigate with clarity.**
